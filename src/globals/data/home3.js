...
export const data = {
    ...
    estimation: {
        ...
        solutions: [
            ...
            },
            {
                ...
                description: "A tracking number for the entire process. so that you can find the exact position. it will help you"
            }
        ]
    },
    ...
    booking: {
        ...
        imageBack: global.booking + "truck-book.png",
        ...
        blogs: [
            {
                ...
                description: "New chip traps clusters of migrating are tumor cells  asperiortenetur, blanditiis odit."
            },
            {
                day: "07",
                month: "Aug",
